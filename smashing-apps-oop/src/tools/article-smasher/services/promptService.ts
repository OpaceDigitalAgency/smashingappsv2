...
const DEFAULT_PROMPTS: PromptTemplate[] = [
  ...
  },
  {
    ...
    systemPrompt: 'You are a professional article writer. Expand the following outline into a complete article, merging bullets into natural paragraphs and keeping only H2/H3-level headings.',
    userPromptTemplate: 'Write a complete 1000+ word article titled "{{title}}" using the outline below as a guide. Expand each point into full paragraphs and remove all numbering or bullet formatting. Keep only natural headings (H2/H3). Naturally incorporate these keywords: {{keywords}}.\n\nOutline:\n{{outline}}\n\nIMPORTANT: Do not reproduce the numbers or bullet points. Write complete flowing paragraphs under each section heading.',
    category: 'content',
    temperature: 0.7,
    maxTokens: 4000,
    createdAt: new Date(),
