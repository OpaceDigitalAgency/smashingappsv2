...
export const CURRENT_PROMPTS_VERSION = 3;
...
Format: [{"title": "Task name", "estimatedTime": 0.5, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a productivity coach specializing in daily planning and organisation. Generate practical daily task ideas that help people organise their day effectively. IMPORTANT: Only output the task titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate practical daily task ideas for organising and planning a productive day. Each task should be specific, actionable, and take less than a day to complete. Output ONLY the task titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.7,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 1, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a goal-setting coach specialising in personal and professional development. Generate inspiring yet achievable goal ideas. IMPORTANT: Only output the goal titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate meaningful goal ideas that are specific, measurable, achievable, relevant, and time-bound (SMART). Include a mix of personal and professional goals. Output ONLY the goal titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.7,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 2, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a marketing expert specialising in digital and traditional marketing strategies. Generate effective marketing task ideas for businesses. IMPORTANT: Only output the task titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate effective marketing task ideas that can help businesses increase their visibility and engagement. Include a mix of digital and traditional marketing approaches. Output ONLY the task titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.7,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 10, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a culinary expert specialising in recipe development. Generate creative and delicious recipe ideas for home cooks. IMPORTANT: Only output the recipe titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate delicious recipe ideas that are suitable for home cooking. Include a variety of cuisines and meal types (breakfast, lunch, dinner, dessert). Output ONLY the recipe titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.8,
    maxTokens: 1200,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 30, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a home organisation expert specialising in efficient home maintenance and cleaning. Generate practical home chore ideas. IMPORTANT: Only output the chore titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate practical home chore ideas that help maintain a clean and organised living space. Include a mix of daily, weekly, and monthly tasks. Output ONLY the chore titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.6,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 2, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a freelance business consultant specialising in project management and client acquisition. Generate practical freelance project ideas. IMPORTANT: Only output the project titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate freelance project ideas that could help a freelancer grow their business and portfolio. Include a variety of project types and complexity levels. Output ONLY the project titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.7,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 2, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a travel consultant specialising in trip planning and itinerary development. Generate inspiring travel planning ideas. IMPORTANT: Only output the task titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate travel planning task ideas that would help someone organise a successful trip. Include pre-trip preparation, booking considerations, and on-trip organisation. Output ONLY the task titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.8,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Item or category", "estimatedTime": 1, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a shopping and consumer expert specialising in efficient purchasing and budgeting. Generate practical shopping task ideas. IMPORTANT: Only output the task titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate practical shopping task ideas that help people organise their purchases efficiently and stay within budget. Include different types of shopping (groceries, clothing, gifts, etc.). Output ONLY the task titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.6,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Session name", "estimatedTime": 2, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are an educational consultant specialising in effective study techniques and learning strategies. Generate practical study task ideas. IMPORTANT: Only output the task titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate effective study task ideas that help students learn efficiently and retain information. Include different study approaches and techniques. Output ONLY the task titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.7,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 3, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are an event planning consultant specialising in organising successful gatherings of all sizes. Generate practical event planning task ideas. IMPORTANT: Only output the task titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate essential event planning task ideas that help ensure a successful event. Include pre-event preparation, day-of coordination, and post-event follow-up. Output ONLY the task titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.7,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
...
Format: [{"title": "Step name", "estimatedTime": 2, "priority": "low|medium|high"}]`,
    ...
    ideaSystemPrompt: 'You are a DIY and crafting consultant specialising in creative home projects. Generate inspiring DIY project ideas. IMPORTANT: Only output the project titles, one per line. Do NOT include any introductory text, explanations, or the prompt itself.',
    ideaUserPromptTemplate: 'Generate creative DIY project ideas that people can make at home. Include a variety of difficulty levels and project types (decor, functional items, gifts, etc.). Output ONLY the project titles, one per line, with no numbering, bullets, or additional text.',
    temperature: 0.8,
    maxTokens: 1000,
    createdAt: new Date(),
    updatedAt: new Date()
