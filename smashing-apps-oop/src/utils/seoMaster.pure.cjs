/**
 * CommonJS wrapper for seoMaster
 * 
 * This is a pure CommonJS file that exports the seoMaster functionality.
 * It's used by Node.js scripts that require CommonJS modules.
 */
 ...
 * @returns {object} - The meta data for the route
 */
